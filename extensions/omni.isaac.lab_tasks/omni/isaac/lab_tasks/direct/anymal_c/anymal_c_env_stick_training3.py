...
class AnymalCEnv(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        rewards = {
            ...
            #"tangential_force_y": force_error_mapped * self.cfg.tangential_force_y * self.step_dt
        }
    ...
    def _reset_idx(self, env_ids: torch.Tensor | None):
        ...
        # Sample new commands
        self._commands[env_ids] = torch.zeros_like(self._commands[env_ids]).uniform_(-0.25, 0.25)
        
        #numero = random.randint(1, 6)
        #numero = 2
        #if numero == 2:
        #    self._commands[env_ids,2] = 0
        #    self._commands[env_ids,1] *= -1
