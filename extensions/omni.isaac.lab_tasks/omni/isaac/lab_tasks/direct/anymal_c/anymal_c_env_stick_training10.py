...
class AnymalCEnv(DirectRLEnv):
    ...
    def _setup_scene(self):
        ...
        self._cuboid_cfg.func("/World/envs/env_.*/Cone", self._cuboid_cfg, translation=(1.25, 0.0, 0.5))
    ...
    def _get_observations(self) -> dict:
        ...
        aa = interaction_force[0][0][0].item()
        print(aa)
        self.count += 0.1
        if (self.count > 1):
            self._commands[:, 1] += 0.001
